...
public class RootDbContextFactory : IDesignTimeDbContextFactory<RootDbContext>
{
    public RootDbContext CreateDbContext(string[] args)
    {
        ...
        optionsBuilder.UseSqlServer("Server=localhost;Database=StarterApi_Root;User Id=sa;Password=YourStrong@Passw0rd;TrustServerCertificate=True;MultipleActiveResultSets=true;");
